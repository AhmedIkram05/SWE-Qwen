...
# These tests need valid GCP credentials to access the GCS state backend
HAS_GCP_CREDS = bool(
...
def get_gcp_project_id() -> str:
    """Read GCP project ID from terraform.tfvars."""
...
def run_terraform_init(terraform_dir: Path) -> subprocess.CompletedProcess:
    """Run terraform init with GCS backend to pull real state."""
...
def get_terraform_outputs() -> dict:
    """Get all real terraform outputs from GCS state as a dictionary."""
...
class TestStorageModuleOutputs:
    ...
    def test_storage_module_has_dataset_bucket_output(self):
...
class TestIAMModuleOutputs:
    ...
    def test_iam_module_has_modal_runner_sa(self):
    ...
    def test_iam_module_has_github_actions_sa(self):
    ...
    def test_iam_module_has_cloud_build_sa(self):
    ...
    def test_iam_module_has_wif_pool(self):
    ...
    def test_iam_module_has_wif_provider(self):
    ...
    def test_iam_module_has_secret_names(self):
        ...
        assert outputs["modal_token_secret_name"]["value"]
        assert outputs["wandb_api_key_secret_name"]["value"]
        assert outputs["github_token_secret_name"]["value"]

    def test_iam_module_has_artifact_registry(self):
...
class TestModuleDependencies:
    ...
    def test_iam_module_receives_storage_outputs(self):
        ...
        result = subprocess.run(
            ...
            env={
                **os.environ,
                ...
                "TF_VAR_repository_owner": "AhmedIkram05",
    ...
    def test_terraform_plan_dry_run(self):
        ...
        result = subprocess.run(
            [
                ...
                "-var=repository_owner=AhmedIkram05",
